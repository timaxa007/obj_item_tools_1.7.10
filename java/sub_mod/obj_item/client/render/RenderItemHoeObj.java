...
public class RenderItemHoeObj implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		GL11.glCallList(ProxyClient.getRenderPart("hoe", "head"));
		Minecraft.getMinecraft().renderEngine.bindTexture(ProxyClient.texture_wooden);
		GL11.glCallList(ProxyClient.getRenderPart("hoe", "stick"));
		GL11.glPopMatrix();
	}
