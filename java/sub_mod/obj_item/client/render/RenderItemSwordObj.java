...
public class RenderItemSwordObj implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		GL11.glCallList(ProxyClient.getRenderPart("sword", "head"));
		Minecraft.getMinecraft().renderEngine.bindTexture(ProxyClient.texture_wooden);
		GL11.glCallList(ProxyClient.getRenderPart("sword", "stick"));
		GL11.glPopMatrix();
	}
