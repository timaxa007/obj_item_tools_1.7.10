...
public class RenderItemShovelObj implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		GL11.glCallList(ProxyClient.getRenderPart("shovel", "head"));
		Minecraft.getMinecraft().renderEngine.bindTexture(ProxyClient.texture_wooden);
		GL11.glCallList(ProxyClient.getRenderPart("shovel", "stick"));
		GL11.glPopMatrix();
	}
