...
public class RenderItemPickaxeObj implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		GL11.glCallList(ProxyClient.getRenderPart("pickaxe", "head"));
		Minecraft.getMinecraft().renderEngine.bindTexture(ProxyClient.texture_wooden);
		GL11.glCallList(ProxyClient.getRenderPart("pickaxe", "stick"));
		GL11.glPopMatrix();
	}
